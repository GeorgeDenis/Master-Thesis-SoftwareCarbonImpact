...
-- Animals: 5000, distributed across the 50 shelters, with random species and microchip codes.
...
-- Medical records: 1000, on a subset of the animals, with diseases drawn from a small set.
